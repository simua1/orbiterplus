...
Widget button(
  ...
  Color backgroundColor = app_colorPrimary,
  double height = 40,
  double width = 150,
}) {
...
class OrbiterButton extends StatefulWidget {
  ...
  var height = 50.0;
  var radius = 5.0;
  var bgColors = app_colorPrimary;
  Color? color = app_colorPrimary;

  OrbiterButton({required this.textContent, required this.onPressed, this.isStroked = false, this.height = 50.0, this.radius = 5.0, this.color, this.bgColors = app_colorPrimary});

  @override
  OrbiterButtonState createState() => OrbiterButtonState();
}

// ignore: camel_case_types
class OrbiterButtonState extends State<OrbiterButton> {
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child:
            text(widget.textContent, textColor: widget.isStroked ? app_colorPrimary : grocery_color_white, fontSize: textSizeMedium, isCentered: true, fontFamily: fontSemiBold, textAllCaps: true),
        decoration: widget.isStroked ? boxDecoration(bgColor: Colors.transparent, color: app_colorPrimary) : boxDecoration(bgColor: widget.bgColors, radius: widget.radius),
      ),
    );
  }
}
