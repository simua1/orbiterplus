  ...
  static EdgeInsetsGeometry only(
    ...
    if (withResponsive) {
      return EdgeInsets.only(
          left: AppSize.getScaledSizeHeight(left),
          right: AppSize.getScaledSizeHeight(right),
          top: AppSize.getScaledSizeHeight(top),
          bottom: AppSize.getScaledSizeHeight(bottom));
    } else {
      return EdgeInsets.only(
