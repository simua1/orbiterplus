  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: title(grocery_lbl_Verify_Number, app_colorPrimary, grocery_color_white, context),
      ),
                ...
                children: <Widget>[
                  ...
                  FittedBox(
                    child: OrbiterButton(
                      ...
                      onPressed: (() {
                        GrocerySuccessfulVerify(orbiter: widget.orbiter).launch(context);
                      }),
